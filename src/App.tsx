...
export default function App() {
  ...
  const normalizeText = (text = "") => {
    return String(text)
      ...
      .replaceAll("粘土", "ねんど")
      .replaceAll("縄跳び", "なわとび")
      .replaceAll("読み聞かせ", "よみきかせ")
      .replaceAll("絵本", "えほん")
      .replaceAll("制作活動", "せいさく")
      .replaceAll("制作", "せいさく")
      .replaceAll("塗り絵", "ぬりえ")
      .replaceAll("お絵描き", "おえかき")
      .replaceAll("絵描き", "おえかき")
      .replaceAll("パズル", "ぱずる")
      .replaceAll("サーキット", "さーきっと")
      .replaceAll("ボール", "ぼーる")
      .replaceAll("ダンス", "だんす")
      .replaceAll("カード", "かーど")
      .replaceAll("ブロック", "ぶろっく")
      .replaceAll("クイズ", "くいず")
      .replaceAll("集団", "しゅうだん")
      .replaceAll("個別", "こべつ")
      .replaceAll("粗大", "そだい")
      ...
      .replaceAll("姿勢", "しせい")
      .replaceAll("手先", "てさき")
      .replaceAll("集中", "しゅうちゅう")
      .replaceAll("協調", "きょうちょう")
      .replaceAll("空間", "くうかん")
      .replaceAll("認知", "にんち")
      .replaceAll("児童発達支援", "じはつ")
      .replaceAll("児発", "じはつ")
      .replaceAll("放課後等デイサービス", "ほうでい")
      .replaceAll("放デイ", "ほうでい");
  };
  ...
  const generatePurpose = async (showAlert = true) => {
    ...
    try {
      ...
      if (data?.purpose && data.purpose !== "AI_ERROR") {
...
${template.support}`;
  ...
  const filteredTemplates = templates.filter((template) => {
    const keyword = normalizeText(displayKeyword);
